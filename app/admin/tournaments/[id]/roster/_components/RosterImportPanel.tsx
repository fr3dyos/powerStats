...
const TEMPLATE = `name,nickname,team
Ada Lovelace,ada,Calculus Crew
Grace Hopper,hopper,Calculus Crew
Alan Turing,alan,Byte Brigade
`;
    ...
    try {
      ...
      if (file) {
        ...
        res = await fetch(endpoint, {
          ...
          body: JSON.stringify({ filename: "roster.csv", content: pasted }),
        });
      } else {
    ...
    <div className="ps-card" style={{ padding: 16 }}>
      ...
      >
        ...
        <textarea
          ...
          placeholder={"name,nickname,team\n..."}
        />
      </fieldset>
